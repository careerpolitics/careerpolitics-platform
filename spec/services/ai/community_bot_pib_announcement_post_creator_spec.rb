...
RSpec.describe Ai::CommunityBotPibAnnouncementPostCreator, type: :service do
  ...
  describe "#generate" do
        ...
        <html>
          <body>
            <div class="innner-page-main-about-us-content-right-part">
              ...
              <div id="lg_g">
                <img src="https://static.pib.gov.in/WriteReadData/specificdocs/photo/2021/aug/ph202183101.png" alt="azadi ka amrit mahotsav">
              </div>
              <p>The Ministry announced major infrastructure steps with implementation details and timeline updates for the public.</p>
              <p><img src="https://static.pib.gov.in/WriteReadData/userfiles/image/event-photo.jpg" alt="event image"></p>
    ...
    it "parses RSS, filters with AI, fetches selected article pages, and returns a generated post" do
      ...
      expect(result.body).to include("![Airport Inauguration](https://static.pib.gov.in/WriteReadData/userfiles/image/event-photo.jpg)")
    ...
    it "includes RSS item numbering in the filter prompt" do
      ...
      allow(ai_client).to receive(:call).with(
        include(
          ...
          "IMAGE_URLS: https://static.pib.gov.in/WriteReadData/userfiles/image/event-photo.jpg",
